...
export default function SurahView() {
  ...
  return (
    ...
    >
      {surah && (
        <Helmet>
          <title>{surahNum === 36 ? 'Surah Yaseen - Read Complete Yaseen with Translation' : surahNum === 18 ? 'Surah Al-Kahf - Read & Listen with English Translation' : surahNum === 3 ? 'Surah Al-Imran - Read Online with English Translation' : surahNum === 22 ? 'Surah Al-Hajj - Read Online with English Translation' : `Surah ${surah.surahName} (${surah.nameTranslation}) - ${surah.arabicName} - Read Online`}</title>
          <meta name="description" content={surahNum === 36 ? 'Read complete Surah Yaseen (Ya-Sin) in Arabic with English translation. Listen to full Yaseen Surah with 7 Qari recitations including Mishary. Free on Al-Quran Hub.' : surahNum === 18 ? 'Read complete Surah Al-Kahf in Arabic with English translation. Listen with 7 Qari recitations including Mishary. First & last 10 verses. Free on Al-Quran Hub.' : surahNum === 3 ? 'Read complete Surah Al-Imran in Arabic with English translation. Last 10 ayahs included. Listen with 7 Qari recitations. Free on Al-Quran Hub.' : surahNum === 22 ? 'Read complete Surah Al-Hajj in Arabic with English translation. Listen with 7 Qari recitations including Mishary. Free on Al-Quran Hub.' : `Read and listen to Surah ${surah.surahName} (${surah.nameTranslation}). Contains ${surah.versesCount} verses. Revealed in ${surah.revelation}. Arabic text, translation and audio available.`} />
