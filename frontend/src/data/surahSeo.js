// Hand-written, keyword-researched title/description per Surah.
// Shared by SurahView.jsx (runtime <Helmet>) and scripts/prerender.js (build-time static HTML)
// so prerendered pages always match exactly what the live page renders — single source of truth.

export const surahSeo = {
  1: {
    title: "Surah Fatiha (Al-Fatiha) | Read & Listen Free — Al-Quran Hub",
    description:
  ...
  2: {
    title: "Surah Baqra (Al-Baqarah) | Read & Listen Full Online Free — Al-Quran Hub",
    description:
  ...
  3: {
    title: "Surah Al-Imran | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  4: {
    title: "Surah An-Nisa | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  5: {
    title: "Surah Al-Maidah | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  6: {
    title: "Surah Al-Anam | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  7: {
    title: "Surah Al-Araf | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  8: {
    title: "Surah Al-Anfal | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  11: {
    title: "Surah Hud | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  12: {
    title: "Surah Yousaf | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  15: {
    title: "Surah Al-Hijr | Read & Listen Free Online — Al-Quran Hub",
    description:
  ...
  16: {
    title: "Surah An-Nahl | Read & Listen Online Free — Al-Quran Hub",
    description:
      "Surah An-Nahl – Quran Chapter 16. Features verse 90 & 125. Arabic, English translation & recitation. Free on Al-Quran Hub.",
  },
  17: {
    title: "Surah Al-Isra | Read & Listen Online Free — Al-Quran Hub",
    description:
  ...
  20: {
    title: "Read & Listen to Surah Taha (Ta-Ha) — Chapter 20 | Al-Quran Hub",
    description:
  ...
  21: {
    title: "Surah Anbiya – Read Online Free | Al-Quran Hub",
    description:
  ...
  22: {
    title: "Surah Al-Hajj – Read Online Free | Al-Quran Hub",
    description:
  ...
  23: {
    title: "Surah Al-Muminun – Read Online Free | Al-Quran Hub",
    description:
  ...
  24: {
    title: "Surah An-Nur | Read & Listen Online on — Al-Quran Hub",
    description:
      "Surah An-Nur (Chapter 24) – Free online reading with English translation & audio recitation. Al-Quran Hub",
  },
  25: {
    title: "Surah Furqan | Read & Listen Online on — Al-Quran Hub",
    description:
  ...
  26: {
    title: "Surah Ash-Shuara | Read & Listen Online on — Al-Quran Hub",
    description:
  ...
  27: {
    title: "Surah An-Naml | Read & Listen Online on  Al-Quran Hub.",
    description:
  ...
  28: {
    title: "Surah Al-Qasas | Read & Listen Online on  Al-Quran Hub",
    description:
  ...
  29: {
    title: "Surah Al-Ankabut | Read & Listen Online on Al-Quran Hub.",
    description:
  ...
  30: {
    title: "Surah Ar-Rum | Read & Listen Online on Al-Quran Hub.",
    description:
  ...
  33: {
    title: "Read Surah Al-Ahzab Online with Translation Free.",
    description:
  ...
  34: {
    title: "Surah Saba | Read & Listen Online — Al-Quran Hub.",
    description:
  ...
  35: {
    title: "Surah Fatir | Read & Listen Online — Al-Quran Hub.",
    description:
  ...
  37: {
    title: "As-Saffat | Surah 37 Read Online — Al-Quran Hub.",
    description:
...
// title/description built from live Surah data (name, translation, verse count, revelation).
export function getSurahSeo(surahNum, surah) {
  const override = surahSeo[surahNum];
  if (override) return override;
  if (!surah) return null;
  return {
    title: `Surah ${surah.surahName} (${surah.nameTranslation}) - ${surah.arabicName} - Read Online`,
    description: `Read and listen to Surah ${surah.surahName} (${surah.nameTranslation}). Contains ${surah.versesCount} verses. Revealed in ${surah.revelation}. Arabic text, translation and audio available.`,
  };
}
