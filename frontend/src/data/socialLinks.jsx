/**
 * data/socialLinks.jsx — Single source of truth for social media links.
 * Shared by Footer and TopBar so both stay in sync automatically.
 */
...
export const SOCIAL_LINKS = [
  { id: 'instagram', label: 'Instagram', href: 'https://www.instagram.com/alquranhub.official/', Icon: InstagramIcon },
  { id: 'linkedin', label: 'LinkedIn', href: 'https://www.linkedin.com/company/alquranhub/', Icon: LinkedInIcon },
  { id: 'youtube', label: 'YouTube', href: 'https://www.youtube.com/@alquranhuborg', Icon: YouTubeIcon },
  { id: 'tiktok', label: 'TikTok', href: 'https://www.tiktok.com/@alquranhuborg', Icon: TikTokIcon },
];
